...
def get_random_students():
    names = ['Ana', 'Giorgi', 'Mari', 'Nika', 'Saba', 'Elene', 'Lasha', 'Tamta', 'Levan', 'Sopho', 'lika' , 'lizi']
    surnames = ['Beridze', 'Kobaladze', 'Kiknadze', 'Jorbenadze', 'Gelashvili', 'Tsiklauri', 'Khutsishvili', 'Gorgodze', 'asanidze']
